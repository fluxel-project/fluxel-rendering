...
assert the seven feature-gated or preserved rows (`StorageImage`, `IndirectDraw`,
...
below; against a real adapter the created device proves copy, proves
...
that and the ledger row equals the pair. Clippy is clean
