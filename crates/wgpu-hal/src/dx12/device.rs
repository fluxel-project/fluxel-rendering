...
impl crate::Device for super::Device {
    ...
    unsafe fn create_sampler(
        ...
        let raw_desc = Direct3D12::D3D12_SAMPLER_DESC {
            ...
            // Backport of gfx-rs/wgpu#10221: a standard (non-comparison)
            // filter must use NONE rather than CompareFunction::default()
            // (ALWAYS), which D3D12 validation rejects in CreateSampler2.
            ComparisonFunc: desc
                .compare
